...
Once you have [deployed a management appliance](/cloudapplicationmanager/making-instance-managed-cloud-application-manager/) within your AWS VPC, you're ready to start deploying managed instances within that VPC. First, you'll need to modify the deployment policy you'd like to use.
